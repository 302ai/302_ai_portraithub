...
ARG NEXT_PUBLIC_MULERUN_URL
ARG NEXT_PUBLIC_MULERUN_API_KEY
...
ENV NEXT_PUBLIC_MULERUN_URL=$NEXT_PUBLIC_MULERUN_URL
ENV NEXT_PUBLIC_MULERUN_API_KEY=$NEXT_PUBLIC_MULERUN_API_KEY
